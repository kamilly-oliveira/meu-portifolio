...
export function ProjectsSection(){
    return(
        <div className="flex flex-1 flex-col mx-12 my-5">
            <h1 className="text-3xl my-4 font-bold bg-gradient-to-r from-purple-600 to-blue-600 dark:from-purple-400 dark:to-blue-400 
        bg-clip-text text-transparent">Projetos</h1>
            <p className="text-gray-600 mb-4 dark:text-gray-300 leading-relaxed">Uma seleção dos meus projetos mais recentes</p>
        <div className="flex flex-wrap gap-4 justify-around">

        <CardProjects 
        link={PortifolioImage}
        titulo={"Portifolio"} 
        descricao={"Portfólio pessoal responsivo com tema escuro/claro e animações suaves."}
        ...
        link={CommunityBot}
        titulo={"Landing Page"} 
        descricao={"Página responsiva que apresenta o bot e coleta interessados via lista de espera."}
        ...
        descricao={"Conversor de Moedas de Dolar, Euro ou Libra Esterlina para Reais."}
