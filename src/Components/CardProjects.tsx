...
export function CardProjects({ titulo, descricao, textBagde, url, link }: Props) {
    ...
    return(
        <div className="shadow-sm rounded-xl w-86 my-4 hover:scale-105 transition-all duration-300 ">
            ...
            <div className="p-6">
            <h1 className="text-2xl my-2 dark:text-white font-semibold">{titulo}</h1>
            <p className="my-2 text-gray-600 mb-4 dark:text-gray-300 leading-relaxed">{descricao}</p>
